...
// 초음파 센서 + 라인센서 판단
// 0번 라인 following : 초음파 센서 장애물 없어야 함
...
void run_heading_angle(void)
{
  ...
  while(flag)
  {
    ...
    motor_R_control(235 + Output);    motor_L_control(235 - Output);
  ...
  void loop()
  {
    ...
    else if(front_sonar < 200)
    {
      ...
      delay(1000);
      motor_L_control(-180);  motor_R_control(1500);
      delay(450);
      motor_L_control(190);  motor_R_control(20);
      delay(1500);
...
void loop1()
{
  ...
  target_heading_angle = 285;
  delay(300);
  imu_rotation();
  run_heading_angle();
  delay(300);

  target_heading_angle = -247;
  delay(300);
  imu_rotation();
  run_heading_angle();
  
  target_heading_angle = 98;
  delay(300);
  imu_rotation();
  run_heading_angle();
  
  target_heading_angle = -200; 
  imu_rotation();  
  run_heading_angle();
  ...
  target_heading_angle = 52;
  imu_rotation();
  run_heading_angle();
  
  target_heading_angle = 86;
  imu_rotation();
  run_heading_angle();
  */
