...
void line_following(int line_index)
{
  switch(line_index)
  {
    ...
    break;
    case -2: motor_L_control(25);  motor_R_control(80);
    break;
    case -1: motor_L_control(45);  motor_R_control(80);
    break;
    case  0: motor_L_control(80);  motor_R_control(-80);
    break;
    case  1: motor_L_control(-80);  motor_R_control(45);
    break;
    case  2: motor_L_control(-80);  motor_R_control(25);
    break;
    case  3: motor_L_control(-80);  motor_R_control(5);
    break;
    case  4: motor_L_control(-80);  motor_R_control(-40);
    break;
