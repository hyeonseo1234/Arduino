...
void line_following(int line_index)
{
  switch(line_index)
  {
    case -4: motor_L_control(-40);  motor_R_control(75); 
    break;
    case -3: motor_L_control(5);  motor_R_control(75);
    break;
    case -2: motor_L_control(25);  motor_R_control(75);
    break;
    case -1: motor_L_control(47);  motor_R_control(75);
    break;
    case  0: motor_L_control(75);  motor_R_control(-77);
    break;
    case  1: motor_L_control(-77);  motor_R_control(47);
    break;
    case  2: motor_L_control(-75);  motor_R_control(25);
    break;
    case  3: motor_L_control(-75);  motor_R_control(5);
    break;
    case  4: motor_L_control(-75);  motor_R_control(-40);
    break;
