...
void loop()
{
  ...
  float front_sonar1,front_sonar2,front_sonar3;
   
  front_sonar1 = sonar[Front].ping_cm()*10;   // 전방 센서 측정
  left_sonar1  = sonar[Left].ping_cm()*10;    // 좌측 센서 측정
  right_sonar1 = sonar[Right].ping_cm()*10;   // 우측 센서 측정
  
  front_sonar2 = sonar[Front].ping_cm()*10;   // 전방 센서 측정
  left_sonar2  = sonar[Left].ping_cm()*10;    // 좌측 센서 측정
  right_sonar2 = sonar[Right].ping_cm()*10;   // 우측 센서 측정
  
  front_sonar3 = sonar[Front].ping_cm()*10;   // 전방 센서 측정
  left_sonar3  = sonar[Left].ping_cm()*10;    // 좌측 센서 측정
  right_sonar3 = sonar[Right].ping_cm()*10;   // 우측 센서 측정
